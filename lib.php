...
function theme_rebel_get_main_scss_content($theme) {
    ...
    if (isset($loginbg)) {
        $pre .= 'body.pagelayout-login {background-image: url("' . $loginbg . '") !important; background-size:cover; background-position:center;}';
    }
...
function theme_rebel_get_pre_scss($theme) {
    global $CFG;
